...
public class TebakGambar2 extends javax.swing.JFrame {
    ...
    public TebakGambar2() {
        ...
        // Import ImageIcon     
        ImageIcon iconLogo = new ImageIcon(getClass().getResource("/ASSET GAME EDU/CPU.png"));
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        if (Angka == 1){
            if (answer.equalsIgnoreCase("cpu")) {
                benar += 1;
            }else {
                salah += 1;
            }
            ...
            labelStat.setText("");
            ImageIcon iconLogo = new ImageIcon(getClass().getResource("/ASSET GAME EDU/mobo.jpeg"));
            labelGambar.setIcon(iconLogo);
        } if (Angka == 2) {
            if (answer.equalsIgnoreCase("motherboard")){
                benar += 1;
            } else {
                salah += 1;
            }
            ...
            labelStat.setText("");
            ImageIcon iconLogo = new ImageIcon(getClass().getResource("/ASSET GAME EDU/psu.jpg"));
            labelGambar.setIcon(iconLogo);
        } if (Angka == 3) {
            if (answer.equalsIgnoreCase("Power Supply")){
                benar += 1;
            } else {
                salah += 1;
            }
            ...
            labelStat.setText("");
            ImageIcon iconLogo = new ImageIcon(getClass().getResource("/ASSET GAME EDU/pci slot.jpg"));
            labelGambar.setIcon(iconLogo);
        } if (Angka == 4) {
            if (answer.equalsIgnoreCase("pci slots")){
                benar += 1;
            } else {
                salah += 1;
            }
            ...
            labelStat.setText("");
            ImageIcon iconLogo = new ImageIcon(getClass().getResource("/ASSET GAME EDU/cpu socket.jpg"));
            labelGambar.setIcon(iconLogo);
            btnResult.setVisible(true);
        } if (Angka == 5) {
            if (answer.equalsIgnoreCase("cpu socket")){
                benar += 1;
            } else {
                salah += 1;
            }
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        if (number == 1){
            ...
            if (answer.equalsIgnoreCase("Mother Board")){
                labelStat.setText("V");
                labelStat.setForeground(Color.green);
            } else {
                labelStat.setText("X");
            ...
            if (answer.equalsIgnoreCase("PCI Slot")){
                labelStat.setText("V");
                labelStat.setForeground(Color.green);
            } else {
                labelStat.setText("X");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TebakGambar2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TebakGambar2().setVisible(true);
            }
        });
    }
